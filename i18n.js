...
const DICTIONARY = {
  ...
  en:{
    ...
    'store.default':'Default','store.galaxy':'Golden galaxy','store.arcane':'Purple runes','store.forest':'Emerald forest','store.storm':'Blue storm','store.royal':'Black crown','store.inferno':'Infernal fire','store.radiant':'Radiant light','store.tech':'Tech emerald','store.login':'Sign in to buy cards.','store.noMoney':'Not enough Coins. You need {price}.','store.equipped':'{name} equipped.','store.bought':'{name} bought and equipped.',
