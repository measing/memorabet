...
const DICTIONARY = {
  es:{
    ...
    'settings.legalText':'MemoraBet usa solo Coins ficticias. No hay apuestas con dinero real ni premios reales.',
    ...
    'auth.subtitle':'Crea tu cuenta o inicia sesión para guardar Coins, historial y ranking en línea.',
    'auth.login':'Ingresar',
    ...
    'rules.three':'Ganas Coins ficticias por cada pareja encontrada. No son dinero real.',
    ...
    'coinGift.title':'Reclamar 1000 coins',
    'coinGift.waitTitle':'Regalo en espera',
    'coinGift.ready':'1000 coins cada 2h',
    'coinGift.wait':'Disponible en {time}',
    'coinGift.claimed':'Recibiste {amount}.',
    'coinGift.login':'Entra como invitado o inicia sesion para reclamar coins.',
    ...
    'mode.wagerInfo':'El ganador recibe el pozo de Coins ficticias y gana copas. El perdedor pierde la entrada ficticia y baja copas.',
    ...
    'store.solar':'Sol dorado',
    'store.venom':'Veneno esmeralda',
    'store.frost':'Cristal helado',
    'store.nature':'Naturaleza dorada',
    'store.banana':'Banana real',
    'store.login':'Inicia sesión para comprar cartas.',
    'store.noMoney':'Coins insuficientes. Necesitas {price}.',
    'store.purchaseFailed':'No se pudo completar la compra. Actualiza el juego y revisa tus Coins.',
    ...
    'msg.noBalance':'No tienes Coins suficientes. Reclama el regalo de Coins o reinicia el juego.',
    'msg.noWagerBalance':'No tienes Coins suficientes para la entrada de {amount}.',
    ...
    'msg.completed':'¡Completaste los 8 pares! Tiempo: {time} · Intentos: {tries} · Recompensa en Coins: {prize}{guestNote}',
    'msg.guestRank':' · Crea una cuenta para entrar al ranking.',
    'msg.finished':'Partida terminada. {matched}/{total} · Resultado: {result} · Coins actuales: {balance}',
    ...
    'online.defaultWin':'Ganaste por abandono.',
    'online.defaultWinLobby':'Ganaste por abandono. Volviendo al lobby...',
    'online.backLobby':'Volviendo al lobby...',
    'online.findGame':'Buscar partida',
    'online.pot':'Pozo de Coins',
    'online.prize':'Recompensa',
  ...
  en:{
    ...
    'store.default':'Default','store.galaxy':'Golden galaxy','store.arcane':'Purple runes','store.forest':'Emerald forest','store.storm':'Blue storm','store.royal':'Black crown','store.inferno':'Infernal fire','store.radiant':'Radiant light','store.tech':'Tech emerald','store.solar':'Golden sun','store.venom':'Emerald venom','store.frost':'Frozen crystal','store.nature':'Golden nature','store.banana':'Royal banana','store.login':'Sign in to buy cards.','store.noMoney':'Not enough Coins. You need {price}.','store.purchaseFailed':'Could not complete the purchase. Refresh the game and check your Coins.','store.equipped':'{name} equipped.','store.bought':'{name} bought and equipped.',
    'msg.start':'Press Start game to begin.','msg.preparing':'A game is already being prepared. Wait a moment.','msg.memorize':'Memorize the cards. You have a few seconds before the visible shuffle.','msg.hiding':'Hiding cards...','msg.shuffling':'Shuffling cards... follow the movement.','msg.play':'Now play. If you followed the movement, you should have real options.','msg.onlineLogin':'To play online you need to sign in or create an account.','msg.noBalance':'Not enough Coins. Claim the Coins gift or restart the game.','msg.noWagerBalance':'You do not have enough Coins for the {amount} entry.','msg.searchingOnline':'Searching for online rival...','msg.leftOnlineWin':'You left the online game. Victory goes to the rival.','msg.leftOnlineRoom':'You left the online room. You can search for another game.','msg.leftGame':'You left the game. Choose a mode or start again.','msg.pairFound':'Pair found. +{amount}.','msg.noPair':'No pair. Tries left: {count}.','msg.completed':'You completed all 8 pairs! Time: {time} · Tries: {tries} · Coins reward: {prize}{guestNote}','msg.guestRank':' · Create an account to enter the ranking.','msg.finished':'Game over. {matched}/{total} · Result: {result} · Current Coins: {balance}','msg.reset':'Game restarted. Press Start game.','msg.avatarSaveFailed':'Could not save avatar online, but it was applied in this browser.',
    'online.searching':'Searching for online rival...','online.found':'Rival found','online.closed':'The online room was closed.','online.waiting':'Room created. Waiting for online rival...','online.ready':'Rival found. Preparing game...','online.preview':'Memorize the cards. The game starts in a few seconds.','online.lobby':'Back to online lobby. You can search for another game.','online.finished':'Online game finished. You can search for another game.','online.turn':'Turn of {name}','online.waitingRival':'Waiting for online rival...','online.win':'You won, {name}','online.winner':'Winner','online.winsGame':'{name} wins the online game.','online.winsLeave':'{name} wins by forfeit.','online.defaultWin':'You won by forfeit.','online.defaultWinLobby':'You won by forfeit. Returning to lobby...','online.backLobby':'Returning to lobby...','online.findGame':'Find game','online.pot':'Coins pot','online.prize':'Reward',
    ...
    'victory.title':'Congratulations!','victory.found':'You found all 8 pairs.','victory.fakePrize':'Coins reward: {prize}','victory.time':'Time','victory.tries':'Tries'
  },
  de:{
  ...
  pt:{
    ...
    'auth.login':'Entrar','auth.loginShort':'Entrar','auth.register':'Criar conta','auth.google':'Entrar com Google','auth.guest':'Jogar como convidado','auth.email':'E-mail','auth.password':'Senha','auth.nickname':'Nickname único','auth.title':'Conta MemoraBet','auth.subtitle':'Crie uma conta ou entre para salvar Coins, histórico e ranking online.','auth.back':'Voltar',
  ...
  fr:{
    ...
    'auth.login':'Connexion','auth.loginShort':'Connexion','auth.register':'Créer un compte','auth.google':'Connexion avec Google','auth.guest':'Jouer en invité','auth.email':'E-mail','auth.password':'Mot de passe','auth.nickname':'Pseudo unique','auth.title':'Compte MemoraBet','auth.subtitle':'Crée un compte ou connecte-toi pour sauvegarder Coins, historique et classement en ligne.','auth.back':'Retour',
...
export function translatePage(){
  ...
  setText('#btn-delete-account', 'settings.deleteAccount');
  ...
  setText('#coin-gift-title', 'coinGift.title');
