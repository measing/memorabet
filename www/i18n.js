...
const DICTIONARY = {
  es:{
    ...
    'coinGift.title':'Reclamar $1.000',
    'coinGift.waitTitle':'Regalo en espera',
    'coinGift.ready':'Disponible cada 2h',
    'coinGift.wait':'Disponible en {time}',
    'coinGift.claimed':'Recibiste {amount} de saldo ficticio.',
    'coinGift.login':'Entra como invitado o inicia sesion para reclamar monedas.',
  ...
  en:{
    ...
    'hud.round':'Round:','hud.pairs':'Pairs:','hud.tries':'Tries','hud.time':'Time','button.newGame':'▶ New game','button.suddenDeath':'▶ Sudden death','button.round':'▶ Round {round}','button.reset':'↻ Restart','button.exit':'↩ Exit','button.start':'Start game','button.mode':'Choose game mode','coinGift.title':'Claim $1,000','coinGift.waitTitle':'Gift waiting','coinGift.ready':'Available every 2h','coinGift.wait':'Available in {time}','coinGift.claimed':'You received {amount} fake balance.','coinGift.login':'Enter as guest or sign in to claim coins.',
...
export function translatePage(){
  ...
  setText('#coin-gift-timer', 'coinGift.ready');
